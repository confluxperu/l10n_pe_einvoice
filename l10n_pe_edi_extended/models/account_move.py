...
class AccountMove(models.Model):
    ...
    def _compute_dte_amount(self):
        for move in self:
            ...
            for line in move.line_ids:
                ...
                # Affected by IGV
                if any(tax.l10n_pe_edi_tax_code in ['1000'] for tax in line.tax_ids) or line.is_tax_base_rounding_line:
                    # Untaxed amount.
    ...
    def _l10n_pe_prepare_dte(self):
        ...
        document = {
            ...
            'partner_street_address': (self.partner_id.street or '') \
            ...
            "amount_others":sum([x[1] for x in self.amount_by_group if x[0] == 'OTROS']),
        ...
        if document['invoice_type_code']=='07':
            ...
            document['rectification_ref_type'] = self.l10n_pe_dte_rectification_ref_type.code if self.l10n_pe_dte_rectification_ref_type else ''
            document['rectification_ref_number'] = self.l10n_pe_dte_rectification_ref_number if self.l10n_pe_dte_rectification_ref_number else ''
        ...
        for line in self.invoice_line_ids:
            if line.display_type == False and line.tax_ids:
    ...
    def _get_name_invoice_report(self):
        self.ensure_one()
        if self.company_id.country_id.code == 'PE' and self.journal_id.l10n_pe_is_dte:
    ...
    '''def _get_last_sequence_from_sunat(self):
    ...
    def _get_last_sequence(self, relaxed=False):
        ...
        if not res and self.journal_id.l10n_pe_is_dte and self.l10n_latam_document_type_id:
            res = self._get_last_sequence_from_sunat()
        return res'''
...
class AccountMoveLine(models.Model):
    ...
    def _get_price_total_and_subtotal_model(self, price_unit, quantity, discount, currency, product, partner, taxes, move_type):
        ...
        if taxes:
            ...
            l10n_pe_dte_price_base = l10n_pe_dte_price_base_signed = taxes_discount['total_excluded']
